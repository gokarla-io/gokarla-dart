...
class PromotionType {
  ...
  static const product = PromotionType._(r'product');
  static const basic = PromotionType._(r'basic');
...
class PromotionTypeTypeTransformer {
  ...
  PromotionType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'product': return PromotionType.product;
        case r'basic': return PromotionType.basic;
        default:
          if (!allowNull) {
